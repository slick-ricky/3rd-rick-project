...
<div class="od_ctn">
	<font color="gray" size="3px">${ordered.od_status}</font>
...
<div class="re_ctn2">
	...
	<div style="display:flex">
		...
		<div class="priceInfo">
			<table style="text-align:left; padding-left:5px;">
				<tr>
					<td class="re_list2">총 주문금액</td>
					<td>${ordered.tp_od}원</td>
				</tr>
				<tr>
					<td class="re_list2">배송비</td>
					<td>${ordered.tp_dvr}원</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
					<td></td>
