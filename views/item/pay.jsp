...
<script>
function ok(){
	if(paybank.value == "" || paybank.value == null){
		alert("결제은행을 선택하세요.");
		paybank.focus();
		return false;
	}
...
<form name="order" action="orderInsert" method="post" onsubmit="return ok()">
<div class="cart_ctn">
	...
	<table border=1 width=100% class="table_box">
		<tr>
			...
			<td><input type="text" name="re_name" id="re_name" value="" style="margin: -2px 4px;"></td>
		</tr>
		<tr>
			<td align=right style="background-color:#f4f4f4;"><b>배송주소</b></td>
			<td>
				<input type="text"  name="re_zip" id="sample6_postcode" placeholder="우편번호" style="width: 150px; margin-top: -2px"> &nbsp;
				...
				<input type="text"  name="re_addr1" id="sample6_address" placeholder="주소" style="width:500px;"><br>
				<input type="text"  name="re_addr2" id="sample6_detailAddress" placeholder="상세주소" style="width:500px; margin-bottom: -2px">
				<input type="text" id="sample6_extraAddress" placeholder="참고항목" style="margin-bottom: -2px">
			</td>
		</tr>
		<tr>
			<td height=40 align=right style="background-color:#f4f4f4;"><b>연락처</b></td>
			<td><input type="text" name="re_phone" style="margin: -2px 4px; width: 200px"><font color="gray" size="2px">("-"없이 숫자만 입력하세요.)</font></td>
		</tr>
		<tr>
			<td height=40 align=right style="background-color:#f4f4f4;"><b>배송요청사항</b></td>
			<td><input type="text" name="re_rq" style="margin: -2px 4px; width: 500px" placeholder="30자 내외로 작성해주세요."></td>
		</tr>
	</table>
	
	<span class="sub_tt">결제요청 <font color="#007a48"><b>${amount}</b></font>건</span><input type=hidden id="od_count" name="od_count" value="${amount}">
	<table border=1 width=100% class="table_box">
		<tr>
		...
		<tr>
			...
			<td>
				<table>
					...
					<tr>
						<td>${list.it_name}</td>
						<td>${list.od_amount}개 <input type="hidden" name="it_uid" value="${list.it_uid}"></td>
						<td width=400 align=right>배송서비스:
							<c:choose>
								<c:when test="${list.od_dvr == 'Y'}">Yes</c:when>
	...
	<table border=1 width=100% class="table_box">
		<tr>
			<td width=120 align=right style="background-color:#f4f4f4;"><b>총주문금액</b></td>
			<td>${tp.totalPrice}원 <input type="hidden" name="tp_od" value="${tp.totalPrice}"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" name="tp_dvr" value="${tp.deliveryPrice}">
			</td>
		</tr>
		<tr>
			...
			<td>
				<div style="display:flex;">
					<div style="width:160px;">
					    <div>
					        <div class="menu">
					            <a><input type="radio" name="payway" id="directpay" value="무통장입금"></a>무통장입금
					            <div class="hide">
					                <div class="nba">
					                	<b>은행선택:</b> 
					                	<select style="margin-bottom:5px;" id="paybank" name="paybank" id="paybank">
					 ...
					 <div style="width:120px;">
					    <div>
					        <div class="menu2">
					            <a><input type="radio" id="kakao" name="payway" value="카카오페이" onclick="abc()"></a>카카오페이
					            <div class="hide">
					                <div class="kakao">
