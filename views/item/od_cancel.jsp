...
<h2 class="tt_2">주문취소/반품내역</h2>

<c:forEach var="list" items="${list}">
<div class="od_date">주문시간: ${list.od_date } / 주문번호: ${list.od_group}
	<a href="/item/od_detail2?od_group=${list.od_group}"><span style="color:#007a48; float:right; font-size:13px; margin-right:10px; cursor:pointer;">주문 상세 보기>></span></a>
</div>

<div class="od_ctn">
	<font color="gray" size="3px">${list.od_status }</font>
