...
function id_search(){
	...
	window.open("id_result?names="+names1+"&tel="+tel2+"&email="+email2, "a", "width=400, height=300");
}
</script>

<center>
<h1 class="tt">아이디 찾기</h2>
</center>
<form method="post">
<div class="id_sch_box">
	<div class="img2"><img src="/img/br1.png" width="200px;"></div>
	<p><font size="5px">아이디가 기억나지 않으세요?</font><br>아래 인증 방법을 통해 아이디를 확인 하실 수 있습니다.</p>
	<div class="id_sch_input">
		<li><input name="names" id="names" placeholder="이름을 입력해주세요."></li>
		<li><input name="tel" id="tel" placeholder="연락처를 입력해주세요."></li>
		<li><input name="email" id="email" placeholder="이메일주소를 입력해주세요."></li>
	</div>
	<div class="id_sch_btn"><span onclick="id_search()" class="log_btn">확인</span></div>
</div>
</form>
<div class="space"></div>
